...
public class InventoryCommandFunctionTest{
    ...
    public void QuitCommand_Successful(){
        Assert.IsInstanceOfType(Services!.GetService<Func<string, InventoryCommand>>()!.Invoke("q"), typeof(QuitCommand), "q should be a quit command");
        Assert.IsInstanceOfType (Services!.GetService<Func<string, InventoryCommand>>()!.Invoke("quit"), typeof(QuitCommand), "quit shoud be a QuitCommand");
    }
